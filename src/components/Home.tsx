...
const Home = ({ hasMetaMask, contract, owner = ethers.ZeroAddress }: Props) => {
  ...
  return (
    <>
      <main className='container mx-auto min-h-screen px-4 py-20 text-secondary sm:pt-28 lg:max-w-5xl lg:px-0'>
        <section className='flex w-full flex-col-reverse items-center justify-evenly rounded-[3rem] bg-secondary py-5 sm:flex-row lg:rounded-[5rem] lg:py-2'>
          <div className='flex h-4/5 flex-col justify-center gap-3 px-4 sm:w-1/2 sm:px-0'>
            ...
            <p className='text-center text-lg font-semibold italic text-white lg:text-xl'>
              ...
              >
                <span className='line-through'>Kovan</span> Sepolia Ethereum
                Test Network
              </a>
              .
            </p>
        ...
        <section className='my-14 text-secondary/90 lg:px-16'>
          ...
          <p className='mt-4 lg:text-lg'>
            ...
            Vote the kweets you like and the most voted will appear at the top
            of the feed. All data is stored exclusively on the Ethereum
            blockchain. No ads, no preferred content, it&apos;s entirely managed
            by the users. Connect your{' '}
            <a
              target='_blank'
              rel='noopener noreferrer'
              className='underline'
          ...
          <p className='mt-4 lg:text-lg'>
            ...
            <span className='font-semibold'>
              to simply demonstrate how blockchain technology can be useful even
          ...
          <p className='mt-4 lg:text-lg'>
            Everything is transparent, all data is public for everyone and there
            is no censoring whatsoever (of course in a real decentralized social
            network public protocols should be implemented in order to prevent
            bad content).
          </p>
          <p className='mt-4 text-center text-sm font-semibold italic text-secondary/90 sm:text-base lg:text-lg'>
            ...
            dreams or about anything you want.{' '}
